set_property SRC_FILE_INFO {cfile:D:/FPGA/FPGA_project/UpCounter/UpCounter.srcs/constrs_1/imports/FPGA_project/MY_Basys-3-Master.xdc rfile:../../../UpCounter.srcs/constrs_1/imports/FPGA_project/MY_Basys-3-Master.xdc id:1} [current_design]
...
set_property -dict { PACKAGE_PIN U2  IOSTANDARD LVCMOS33 } [get_ports { digitPosition[0]  }]; #IO_L9N_T1_DQS_34   ,Sch=DP
set_property src_info {type:XDC file:1 line:64 export:INPUT save:INPUT read:READ} [current_design]
set_property -dict { PACKAGE_PIN U4  IOSTANDARD LVCMOS33 } [get_ports { digitPosition[1]  }]; #IO_L11P_T1_SRCC_34 ,Sch=DP
set_property src_info {type:XDC file:1 line:65 export:INPUT save:INPUT read:READ} [current_design]
set_property -dict { PACKAGE_PIN V4  IOSTANDARD LVCMOS33 } [get_ports { digitPosition[2]  }]; #IO_L11N_T1_SRCC_34 ,Sch=DP
set_property src_info {type:XDC file:1 line:66 export:INPUT save:INPUT read:READ} [current_design]
set_property -dict { PACKAGE_PIN W4  IOSTANDARD LVCMOS33 } [get_ports { digitPosition[3]  }]; #IO_L12N_T1_MRCC_34 ,Sch=DP
