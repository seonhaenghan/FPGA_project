...
set_property -dict { PACKAGE_PIN V17  IOSTANDARD LVCMOS33 } [get_ports { i_SMR[0]  }]; #IO_L19N_T3_A09_D25_VREF_14 ,Sch=SW0
#set_property -dict { PACKAGE_PIN V16  IOSTANDARD LVCMOS33 } [get_ports { i_SMR[1]  }]; #IO_L19P_T3_A10_D26_14      ,Sch=SW1
#set_property -dict { PACKAGE_PIN W16  IOSTANDARD LVCMOS33 } [get_ports { i_SMR[2]  }]; #IO_L20P_T3_A08_D24_14      ,Sch=SW2
#set_property -dict { PACKAGE_PIN W17  IOSTANDARD LVCMOS33 } [get_ports { i_SMR[3]  }]; #IO_L20N_T3_A07_D23_14      ,Sch=SW3
...
set_property -dict { PACKAGE_PIN T1   IOSTANDARD LVCMOS33 } [get_ports { i_SMR[2] }]; #IO_L3P_T0_DQS_34           ,Sch=SW14
set_property -dict { PACKAGE_PIN R2   IOSTANDARD LVCMOS33 } [get_ports { i_SMR[3] }]; #IO_L1P_T0_34               ,Sch=SW15
...
#set_property -dict { PACKAGE_PIN T18  IOSTANDARD LVCMOS33 } [get_ports {  }]; #IO_L17N_T2_A13_D29_14 ,Sch=BTNU
set_property -dict { PACKAGE_PIN W19  IOSTANDARD LVCMOS33 } [get_ports { i_SMR[1] }]; #IO_L16N_T2_A15_D31_14 ,Sch=BTNL
...
set_property -dict { PACKAGE_PIN A14  IOSTANDARD LVCMOS33 } [get_ports { o_motor_step[0] }]; #IO_L6P_T0_16       ,Sch=JB1
set_property -dict { PACKAGE_PIN A16  IOSTANDARD LVCMOS33 } [get_ports { o_motor_step[1] }]; #IO_L12P_T1_MRCC_16 ,Sch=JB2
set_property -dict { PACKAGE_PIN B15  IOSTANDARD LVCMOS33 } [get_ports { o_motor_step[2] }]; #IO_L11N_T1_SRCC_16 ,Sch=JB3
set_property -dict { PACKAGE_PIN B16  IOSTANDARD LVCMOS33 } [get_ports { o_motor_step[3] }]; #IO_L13N_T2_MRCC_16 ,Sch=JB4
