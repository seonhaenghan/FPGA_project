...
module design_mb_tg_wrapper
  ...
  design_mb_tg design_mb_tg_i
       (.button_tri_i({button_tri_i_3,button_tri_i_2,button_tri_i_1,button_tri_i_0}),
        ...
        .reset(reset),
        .switch_tri_i({switch_tri_i_1,switch_tri_i_0}),
        .switch_tri_o({switch_tri_o_1,switch_tri_o_0}),
        .switch_tri_t({switch_tri_t_1,switch_tri_t_0}),
        .sys_clock(sys_clock),
