...
set_property -dict { PACKAGE_PIN W19  IOSTANDARD LVCMOS33 } [get_ports { i_button[3] }]; #IO_L16N_T2_A15_D31_14 ,Sch=BTNL
set_property -dict { PACKAGE_PIN T17  IOSTANDARD LVCMOS33 } [get_ports { i_button[4] }]; #IO_L17P_T2_A14_D30_14 ,Sch=BTNR
set_property -dict { PACKAGE_PIN U17  IOSTANDARD LVCMOS33 } [get_ports { i_button[1] }]; #IO_L18P_T2_A12_D28_14 ,Sch=BTND


##Pmod Header JA

set_property -dict { PACKAGE_PIN J1  IOSTANDARD LVCMOS33 } [get_ports { o_pwm_motor }]; #IO_L3N_T0_DQS_AD5N_35 ,Sch=JA1
